...

{
    ...
    is $result->value,          '39', "$num1 / $num2 - value";
...

{
    ...
    is $result->value,          '-24798', "$num1 / $num2 - value";
...

{
    ...
    my $instance2 = Math::FixedPoint->new($num2);
    my $result    = $num1 / $instance2;

    is $result->value,          '-248', "$num1 / $num2 - value";
    is $result->decimal_places, 2,      "$num1 / $num2 - decimal_places";
}
...

{
    ...
    eval { my $result = $instance1 / $instance2 };
    like $@, qr/Illegal division by zero at/, "$num1 / $num2 - value";
}
