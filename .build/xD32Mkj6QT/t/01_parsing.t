...
( $num, $decimal_places ) = Math::FixedPoint->_parse_num("1.23e6");
is $num,            '1230000', 'Scientific Positive Float > 1 - Num';
is $decimal_places, 0,         'Scientific Positive Float > 1 - Decimal Places';
